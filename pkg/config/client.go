...
type ClientCommonConf struct {
	...
	// DelEnable specifies whether to delete the configuration file after loading
	DelEnable bool `ini:"del_enable" json:"del_enable"`
	...
	// Specifies the path on which the WebSocket listens
	WebSocketPath string `ini:"websocket_path" json:"websocket_path"`
	// Specify the Host Header for the WebSocket connection
	WebSocketHost string `ini:"websocket_host" json:"websocket_host"`
}
